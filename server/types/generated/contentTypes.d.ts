...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Category_description: Schema.Attribute.String;
...
export interface ApiInstructorInstructor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description_teacher: Schema.Attribute.String;
...
export interface ApiUserAvatarUserAvatar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    avatar_img: Schema.Attribute.Media<'files' | 'images', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    UID: Schema.Attribute.Integer & Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_avatar: Schema.Attribute.Relation<
      'oneToOne',
      'api::user-avatar.user-avatar'
    >;
