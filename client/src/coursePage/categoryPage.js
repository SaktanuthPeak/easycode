...
const CategoryPage = () => {
    ...
    const baseURL = "http://localhost:1337"; // เปลี่ยนเป็น URL จริงของ API
    ...
    return (
        <div className="container mx-auto p-6">
            <h1 className="text-3xl font-bold">{categoryData.Category_name}</h1>
            ...
            <div className="grid grid-cols-3 gap-6 mt-6">
                {categoryData.courses.map((course) => (
                    ...
                    >
                        <img
                            src={course.course_img?.length > 0 ? `${baseURL}${course.course_img[0].url}` : strapi}
